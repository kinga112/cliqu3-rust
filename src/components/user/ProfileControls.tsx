...
export function ProfileControls() {
  ...
  const [profileMenuVisibility, setProfileMenuVisibility] =
    useState("invisible");
  ...
  return (
    <>
      <div ref={profileMenuRef} className="flex flex-col relative">
        ...
        <div
          className={
            "absolute flex p-2 gap-1 left-[75px] bottom-0 bg-off-black-400 border border-off-black-300 rounded-2xl z-20 " +
        ...
        >
          ...
          {profile == null ? (
            ...
            // <div />
            <UserInfoLarge profile={profile} />
          )}
          <div className="flex flex-col justify-evenly p-1 bg-off-black-300 rounded-xl">
            <button
              className="p-1 hover:bg-off-black-200 rounded-md"
              onClick={() => setAudio(!audio)}
            >
              {audio ? (
                <img src={mic} width={25} height={25} />
              ) : (
                <img src={muted_mic} width={25} height={25} />
              )}
            </button>
            <button
              className="p-1 hover:bg-off-black-200 rounded-md"
            ...
            >
              {silence ? (
                <img src={muted_headphones} width={25} height={25} />
              ) : (
            ...
            <button
              className={
                video
                  ? "p-1 hover:bg-off-black-200 rounded-md bg-green-500"
                  : "p-1 hover:bg-off-black-200 rounded-md bg-red-500"
              }
