...
import { EMOJIs } from "../../../types/messageTypes"
...
export function EmojiGrid(props: {cid: string, from: string, reactions: {[emoji: string]: {count: number, users: string[]}}}){
  ...
  return(
    <>
      <div className="inline-grid gap-1 grid-cols-8 place-items-center text-3xl p-0.5 h-96 max-w-full overflow-y-auto overflow-x-hidden no-scrollbar">
        {emojiElements}
      </div>
    </>
  )
