...
export function OptionsMenuButton() {
  const [optionsMenuVisibility, setOptionsMenuVisibility] =
    useState("invisible");
  ...
  const setShowCreateServerModal = useGlobalStore(
    (globals) => globals.setShowCreateServerModal,
  );
  ...
  function outsideOptionsMenuAlerter(
    optionsMenuRef: React.MutableRefObject<any>,
    optionsMenuButtonRef: React.MutableRefObject<any>,
  ) {
    useEffect(() => {
  ...
  async function joinServer() {
    ...
    const ticket =
      "";
    ...
    <>
      <div className="flex flex-col relative">
        ...
        <div
          ref={optionsMenuRef}
          className={
            "absolute flex flex-col p-2 gap-1 left-[75px] w-32 bg-off-black-400 border border-off-black-300 rounded-2xl z-20 " +
        ...
        >
          ...
          <button className={buttonStyle} onClick={joinServer}>
            <img
          ...
          <button className={buttonStyle} onClick={setScreenToSettings}>
