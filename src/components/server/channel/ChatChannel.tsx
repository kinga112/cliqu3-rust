...
export function ChatChannel() {
  ...
  return (
    <>
          ...
          {currentTextChannel.id != "" ? (
            <div className="flex">
              <button
                ...
                className="flex justify-center place-items-center h-10 w-10 rounded-md bg-deep-purple-300"
              >
      ...
      {currentTextChannel.id != "" && showUsers ? (
        <MembersList key={currentTextChannel.id} />
      ) : (
        <div />
      )}
    </>
