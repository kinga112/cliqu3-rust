...
function DisplayName(props: { profile: MemberProfile }) {
  ...
  let displayName = props.profile.address;
  // console.log("PROFILE:", props.member.name);
  ...
  return (
    <>
      <div className="relative">
        <button
          onClick={handleClick}
          className="relative text-lg font-semibold hover:underline hover:text-deep-purple-200"
        >
          {displayName}
        </button>
        {/* user profile */}
        {showMenu && menuPosition && (
          ...
          >
            <UserInfoLarge
              ...
              // address={"0xd8dA6BF2d816a1c2b10621b86005291b65b22401"}
